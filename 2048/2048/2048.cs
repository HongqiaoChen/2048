...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        void resourcePrepare()
        {
            ...
            bufferGraphics.DrawString("   If you are lucky enough to \nfind a bug, please contact me\n        at QQ1214120451 ", new Font("Microsoft Yahei", 10, FontStyle.Bold), new SolidBrush(Color.FromArgb(120, 110, 112)), new PointF(105, 360));
            bufferGraphics.DrawString("Power By HongqiaoChen,\n       陈泓桥 China", new Font("Microsoft Yahei", 15, FontStyle.Bold), new SolidBrush(Color.FromArgb(120, 110, 112)), new PointF(90, 290));
